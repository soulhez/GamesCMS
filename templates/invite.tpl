...
<h2 class="homepage" style="text-align:center;font-weight:bold">Invite Friends to Lagged</h2>
<div style="margin:0 auto;width:98%;padding:0 1%;max-width:500px">
<p class="bg-caution signuppage" style="margin:20px 0 0 0;width:98%;text-align:center">Earn <b>25xp</b> for each friend that signs up!</p>
...
<a href="mailto:?subject=Play%20Games&amp;body=Come%20join%20me%20at%20{$settings['siteurl']|escape}({$settings['siteurl']|escape})%20and%20challenge%20me%20to%20some%20games!" target="_blank">
