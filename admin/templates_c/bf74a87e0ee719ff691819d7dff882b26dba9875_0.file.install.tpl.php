<?php
/* Smarty version 3.1.29, created on 2017-01-18 16:08:10
  from "/home/gbapi/public_html/lagged/admin/templates/install.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5880036ad4cd66_96007060',
  'file_dependency' => 
  array (
    'bf74a87e0ee719ff691819d7dff882b26dba9875' => 
    array (
      0 => '/home/gbapi/public_html/lagged/admin/templates/install.tpl',
      1 => 1484784489,
      2 => 'file',
    ),
  ),
...
function content_5880036ad4cd66_96007060 ($_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('title'=>'Install Game'), 0, false);
?>

<div class="container">
<div class="row">
<div class="page-header">
<h4>Install Game <?php echo stripslashes($_smarty_tpl->tpl_vars['game']->value['name']);?>
</h4>
</div>
<?php if ($_smarty_tpl->tpl_vars['game']->value['installed'] == 1) {?><p class="bg-danger">Warning: You have already installed this game!</p><?php }
if ($_smarty_tpl->tpl_vars['errors']->value) {?><p class="bg-danger"><?php echo $_smarty_tpl->tpl_vars['errors']->value;?>
</p><?php }
...
/g/<?php echo $_smarty_tpl->tpl_vars['gamelink']->value;?>
...
/install.php?source=<?php echo $_smarty_tpl->tpl_vars['source']->value;?>
&id=<?php echo $_smarty_tpl->tpl_vars['game']->value['id'];?>
...
<?php if ($_smarty_tpl->tpl_vars['game']->value['thumb']) {?><img src="<?php echo $_smarty_tpl->tpl_vars['game']->value['thumb'];?>
" alt="" /><?php } else { ?>
...
<textarea name="embed" cols="50" required rows="1" id="exampleInputEmail8"><?php echo $_smarty_tpl->tpl_vars['game']->value['swf'];?>
</textarea>
</div>
...
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox1" name="feature" value="1" <?php if ($_smarty_tpl->tpl_vars['game']->value['feature']) {?>checked<?php }?>> Feature
</label>
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox2" name="hasscores" value="1" <?php if ($_smarty_tpl->tpl_vars['game']->value['has_scores']) {?>checked<?php }?>> High Scores
</label>
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox3" name="hasawards" value="1" <?php if ($_smarty_tpl->tpl_vars['game']->value['has_achs']) {?>checked<?php }?>> Achievements
</label>
<label class="checkbox-inline">
  <input type="checkbox" id="inlineCheckbox3" name="ads" value="1" <?php if ($_smarty_tpl->tpl_vars['game']->value['ads']) {?>checked<?php }?>> Video Ads
</label>
</div>
